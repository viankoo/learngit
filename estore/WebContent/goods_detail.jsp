...
<script type="text/javascript">
	function checkNum(gid) {
		var value = buynum.value;
		if (value==null) {
			alert("请输入购买数量！");
			return;
		}
		...
		location.href="${path}/cartServlet?method=addCart&gid="+gid+"&buynum="+n;
	} 
</script>
</head>
<body>
	...
	<div id="goodsInfo" class="clearfix">
		...
		<div class="textInfo">
			...
			<ul class="bnt_ul">
				<li class="clearfix">
					<dd>
						<strong>购买此商品可使用：</strong><font class="f4">${goods.estoreprice*0.1 } 积分</font>
					</dd>
				</li>
				<li class="clearfix">
					<dd>
						...
						<span id="buyspan"></span>
					</dd>
				</li>
				<li class="padd">
					<a href="javascript:void(0);" onclick="checkNum(${goods.id});">
